...
# 
# Experimentally, consider a set of values for $U$ determined by varying $\dot{q}_h$ and $\dot{q}_c$ over range of values. Because Reynold's number is proportional to flowrate, we can propose a model
# 
